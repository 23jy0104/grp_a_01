...
<head>
    ...
    <style> 
		.reservation-inputs { display: flex; flex-direction: column; gap: 20px; }
		.time-group {
		display: flex;
...
<body>
    ...
    <main>
        ...
        <div id="timetable" class="timetable">
            ...
            <div id="reserve-button-container" style="display:none;">
                <button type="button" onclick="submitReservation()">検索</button>
            </div>
        </div>
    </main>
    ...
    <form id="reservationForm" action="CarAvailabilityServlet" method="post">
